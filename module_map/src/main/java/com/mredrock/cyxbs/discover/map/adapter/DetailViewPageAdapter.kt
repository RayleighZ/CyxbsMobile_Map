    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        if (listOfImageUrls.isNotEmpty()){
            Glide.with(context).load(listOfImageUrls[position])
                    ...
                    .placeholder(R.drawable.map_placeholder_detail_pic)
                    .error(R.drawable.map_placeholder_detail_pic)
                    .override(280 , 185)
                    .into(iv)
        }
        else{
            Glide.with(context).load(R.drawable.map_placeholder_detail_pic)
                    .override(280 , 185)
                    .into(iv)
        }
